...
namespace Google.GenAI.Types {
  ...
  internal record CreateTuningJobParameters {
    /// <summary>
    ...
    /// <returns>The deserialized CreateTuningJobParameters object, or null if deserialization
    /// fails.</returns>
    public static CreateTuningJobParameters
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<CreateTuningJobParameters>(jsonString, options);
