...
namespace Google.GenAI.Types {
  ...
  public record TuningValidationDataset {
    /// <summary>
    ...
    /// <returns>The deserialized TuningValidationDataset object, or null if deserialization
    /// fails.</returns>
    public static TuningValidationDataset
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<TuningValidationDataset>(jsonString, options);
