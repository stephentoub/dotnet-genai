...
public class FilesUploadTest
{
    ...
    [TestMethod]
    public async Task UploadFilePathVertexTest()
    {
    ...
    [TestMethod]
    public async Task UploadBytesVertexTest()
    {
       byte[] fileBytes = await System.IO.File.ReadAllBytesAsync("TestAssets/google_small.png");
       var ex = await Assert.ThrowsExceptionAsync<NotSupportedException>(async () =>
       {
