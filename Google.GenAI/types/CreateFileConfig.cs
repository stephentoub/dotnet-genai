...
namespace Google.GenAI.Types {
  ...
  public record CreateFileConfig {
    /// <summary>
    ...
    /// <returns>The deserialized CreateFileConfig object, or null if deserialization
    /// fails.</returns>
    public static CreateFileConfig
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<CreateFileConfig>(jsonString, options);
