...
public class FilesDeleteTest
{
    ...
    [TestMethod]
    public async Task DeleteVertexTest()
    {
    ...
    [TestMethod]
    public async Task DeleteFullFileNameGeminiTest()
    {
       string fileName = "files/s9w1hwysc7qz";
       var response = await geminiClient.Files.DeleteAsync(name: fileName);

       Assert.IsNotNull(response);
    }

    [TestMethod]
    public async Task DeleteShortFileNameGeminiTest()
    {
       string fileName = "widgre2dosi5";
       var response = await geminiClient.Files.DeleteAsync(name: fileName);
