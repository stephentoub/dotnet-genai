...
namespace Google.GenAI.Types {
  ...
  public record BigQuerySource {
    ...
    /// <returns>The deserialized BigQuerySource object, or null if deserialization fails.</returns>
    public static BigQuerySource
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<BigQuerySource>(jsonString, options);
